                                ...
                                <div class="modal-dialog modal-lg " role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?php echo base_url('addcustomerpart') ?>" method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="po_num">Packing Qty </label><span
                                                                class="text-danger">*</span>
                                                            <input type="number" name="qty" required
                                                                class="form-control" id="exampleInputEmail1"
                                                                placeholder="Enter Qty" aria-describedby="emailHelp">
                                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="card bg-light mb-3" style="max-width: 27rem;"
                                                    id="my-node<?php echo $i ?>">
                                                    <div class="card-body" style="font-weight: bold;">
                                                    <div class="print-container qr-code">
                                                        <p class="card-text" style="font-size:20px">Part No
                                                            :<?php echo $parts[0]->part_number; ?>
                                                            <br>
                                                ...
                                                <button onclick="printDiv('my-node<?php echo $i ?>')"
                                                ...
                                                <!-- <script>
                                                            ...
                                                            btn.onclick = function() {
                                                                ...
                                                                downloadSVG('my-node<?php echo $i ?>')
                                                                // node.innerHTML = "I'm an image now."
                                                                domtoimage.toBlob(document.getElementById(
                                                                    'my-node<?php echo $i ?>')).then(function(blob) {
                                                                    window.saveAs(blob,
                                                                        '<?php echo $parts[0]->part_number; ?>.png'
                                                                    );
                                                        ...
                                                        function downloadSVG(id) {
                                                            const svg = document.getElementById('123').innerHTML;
                                                            const blob = new Blob([svg.toString()]);
                                                            const element = document.createElement("a");
                                                            element.download = "<?php echo $parts[0]->part_number; ?>.svg";
                                                      ...
                                                      // $qr_code_data = $po->part_number." ".$po->part_qty." ".$po->created_time." ".$po->part_description." ".$po->vendor_code;
                                                       ...
                                                       //  this is for generation of qr code
                                                        var qrcode = new QRCode(document.querySelector(
                                                            ".qrcode<?php echo $i; ?>"), {
                                                            text: qrData,
                                                            width: 128,
                                                            height: 128,
                                             ...
                                             <script>
                                                // Event listener for the button click
                                                    var node = document.getElementById('my-node<?php echo $i ?>');
                                                        ...
                                                        var btn = document.getElementById('foo<?php echo $i ?>');
                                                        btn.onclick = function() {
                                                            const nodeId = 'my-node<?php echo $i ?>';

                                                            domtoimage.toBlob(document.getElementById(nodeId))
                                                                .then(function(blob) {
