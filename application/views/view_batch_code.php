                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-2 ml-4">
                                    <div class="form-group">
                                        <form action="<?php echo base_url('view_batch_code'); ?>" method="post">
                                            <label for="">Select Batch Code</label>
                                            <select required name="batch_code" id="" class="form-control select2">
                                                ...
                                                ?>
                                                        <option <?php
                                                                if ($v->batch_code == $batch_code_selected) {
                                                                    echo "selected";
                                                                }
                                                                ?> value="<?php echo $v->batch_code ?>"><?php echo $v->batch_code ?></option>
                                                <?php
                                                    }
                                                }
                                                ?>
                            ...
                            <?php
                            if ($packing) {
                                if (!$batch_code_document) {
                            ?>
                                    <div class="row">
                                        <div class="col-lg-2 ml-4">
                                            <div class="form-group">
                                                <form action="<?php echo base_url('upload_batch_document') ?>" method="POST" enctype='multipart/form-data'>

                                                    <label for="">Upload Document <span class="text-danger">*</span></label>
                                                    <input type="file" required name="document" class="form-control">
                                                    <input type="hidden" value="<?php echo $batch_code_selected ?>" required name="batch_code" class="form-control">
                                            </div>
                                        </div>
                                ...
                                ?>
                                    <div class="row">
                                        <div class="col-lg-2 ml-4">
                                            <a download href="<?php echo base_url('documents/') . $batch_code_document[0]->document; ?>" class="btn btn-sm btn-success">Document donwload</a>
                                        </div>
                                    </div>
                            <?php
                                }
