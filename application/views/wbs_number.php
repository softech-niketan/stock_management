                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">WBS Number</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">WBS Number</h3>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal">
                                    Add WBS Number </button>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add OCWBS Number </h5>
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo base_url('addOtherData') ?>" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="part_name">WBS Number</label><span class="text-danger">*</span>
                                                        <input type="text" name="hus_num" required class="form-control" id="hus_num" aria-describedby="emailHelp" placeholder="WBS Number">
                                                        <input value="wbs" name="type" type="hidden" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Machine Name">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="<?php echo base_url('updateOtherData') ?>" method="POST">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="part_name">WBS Number</label><span class="text-danger">*</span>
                                                                                <input type="text" value="<?php echo $p->number; ?>" name="uhus_num" required class="form-control" id="hus_num" aria-describedby="emailHelp" placeholder="WBS Number">
