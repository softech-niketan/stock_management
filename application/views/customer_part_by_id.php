                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="part_desc" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select readonly class="form-control select2" name="uom" style="width: 100%;">
                                                                ...
                                                                foreach ($uom as $c) {
                                                                    if (true) {
                                                                ?>
                                                                        <option value="<?php echo $c->uom_name; ?>"><?php echo $c->uom_name; ?></option>
                                                                <?php
                                                                    }
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select readonly class="form-control select2" name="customer_part_id" style="width: 100%;">
                                                                <?php
                                                                foreach ($customers_part_type as $c) {

                                                                ?>
                                                                    <option value="<?php echo $c->id; ?>"><?php echo $c->customer_type_name; ?></option>
                                                                <?php
