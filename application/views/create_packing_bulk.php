                                ...
                                <div class="modal-dialog modal-lg " role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Create Bulk Qty </h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form method="post" action="<?php echo base_url('create_packing_data_bulk'); ?>">
                                                <div class="row">
                                                    ...
                                                    <input type="number" placeholder="Enter Packing Barcode" required name="scan_code" class="form-control">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="">Enter Packing / Barcode Qty <span class="text-danger">*</span></label>
                                                            <input type="number" class="form-control" step="any" value="1" name="packing_qty" required placeholder="Enter Bulk Qty">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Enter Batch Code <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" name="batch_code" required placeholder="Enter ">
                                                        </div>
