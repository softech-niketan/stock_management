                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                            <form action="<?php echo base_url('update_prod_qty'); ?>" method="post">

                                                                <input type="number" required max="<?php echo $req_qty; ?>" name="production_qty" placeholder="Accept Qty" class="form-control">
                                                                <input type="hidden" value="<?php echo $child_part_master[0]->id; ?>" name="child_part_master_id" placeholder="Accept Qty" class="form-control">
                                                                <input type="hidden" value="<?php echo $req_qty; ?>" name="req_qty" placeholder="Accept Qty" class="form-control">
