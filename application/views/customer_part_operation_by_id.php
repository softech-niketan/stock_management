                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        if ($customer_part_rate) {
                                            foreach ($customer_part_rate as $poo) {
                                                ...
                                                $array = array(
                                                    "customer_master_id" => $poo->customer_master_id,
                                                    "operation_id" => $poo->operation_id,

                                                );

                                                $customer_part_rate_data = $this->Crud->get_data_by_id_multiple_condition("customer_part_operation", $array);
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="hidden" value="<?php echo $customer_part_rate_data[0]->operation_id ?>" name="operation_id" required class="form-control" id="exampleInputEmail1" placeholder="Enter Part Rate" aria-describedby="emailHelp">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <div class="form-group">
                            ...
                            <td><?php echo $customer_part_rate_data[0]->name ?></td>
                            <td><?php echo $customer_part_rate_data[0]->mfg ?></td>
                            <td>
                                <a class="btn btn-info" href="<?php echo base_url('add_operation_details/') . $customer_part_rate_data[0]->id; ?>">Add Details</a>
                            </td>
