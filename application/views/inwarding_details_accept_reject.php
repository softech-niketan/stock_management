<div style="width:2300px" class="wrapper">
        <!-- Navbar -->
                                                                ...
                                                                <div class="row">
                                                                        <div class="col-lg-2">
                                                                                <div class="form-group">
                                                                                        ...
                                                                                        <a class="btn btn-danger" href="<?php echo base_url('accept_reject_validation'); ?>">
                                                                                                < Back</a>
                                                                                                                ...
                                                                                                                <div class="modal-body">
                                                                                                                        <form action="<?php echo base_url('accept_inwarding_data') ?>" method="POST">
                                                                                                                                <div class="row">
                                                                                                                                        <div class="col-lg-12">
                                                                                                                                                <div class="form-group">
                                                                                                                                                        <label> Are You Sure Want To Accept This Inwarding ?</label><span class="text-danger">*</span>
                                                                ...
                                                                <table class="table table-bordered table-striped" id="example1">
                                                                        <thead>
                                                                                ...
                                                                                <tr>
                                                                                        ...
                                                                                        <th>Balance QTY</th>
                                                                                        <th>Price</th>
                                                                                        <th>Entered Inwarding Qty</th>
                                                                                        <th>Entered GRN Validation Qty</th>
                                                                                        <th>Entered Accept Qty</th>
                                                                                        <th> Reject Qty</th>
                                                                                        <th> Remark</th>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                        ...
                                                                                                                        ?>
                                                                                                                                ...
                                                                                                                                <form action="<?php echo base_url('update_grn_qty_accept_reject') ?>" method="post">

                                                                                                                                        <input type="number" value="" id="searchTxt" required max="<?php echo $grn_details_data[0]->verified_qty; ?>" placeholder="Accept Qty" name="accept_qty" class="form-control">
                                                                                                                                        ...
                                                                                                                                        <input type="hidden" placeholder="Enter Inwarding Qty" name="verified_qty" value="<?php echo $grn_details_data[0]->verified_qty ?>" class="form-control">
                                                                                                                                        <input type="hidden" placeholder="Enter Inwarding Qty" name="part_id" value="<?php echo $p->part_id ?>" class="form-control">
                                                                                                                                <?php
