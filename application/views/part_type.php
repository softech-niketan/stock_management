    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Child Part Type</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active"> Child Part Type</li>
                        </ol>
                    </div>
                                    ...
                                    <div class="modal-dialog" role=" document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Add Part Type</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="<?php echo base_url('addpartType') ?>" method="POST">
                                                    <div class="row">
                                                        <div class="col-lg-12">

                                                            <div class="form-group">
                                                                <label for="contractorName">Part Type Name</label><span class="text-danger">*</span>
                                                                <input type="text" name="parttypeName" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Paty Type Name">
                                                            </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><?php echo $t->part_type_name ?></td>
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form action="<?php echo base_url('updatepartType') ?>" method="POST">
                                                                            <div class="row">
                                                                                <div class="col-lg-12">

                                                                                    <div class="form-group">
                                                                                        <label for="customer_name">Part Type Name</label><span class="text-danger">*</span>
                                                                                        <input value="<?php echo $t->part_type_name ?>" type="text" name="uparttypeName" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Customer Name">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="<?php echo base_url('delete') ?>" method="POST">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input value="part_type" name="table_name" type="hidden" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Machine Name">
