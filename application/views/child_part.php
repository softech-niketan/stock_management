                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                                ...
                                                <form action="<?php echo base_url('addchildpart') ?>" method="POST" enctype='multipart/form-data' s>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="po_num">Part Drawing </label>
                                                                <input type="file" name="part_drawing" class="form-control" id="hsn_code" placeholder="Enter HSN Code" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                    ...
                                    <tbody>
                                        ...
                                        if ($child_part_list) {
                                            foreach ($child_part_list as $poo) {
                                                ...
                                                $supplier_data = $this->Crud->get_data_by_id("supplier", $po[0]->supplier_id, "id");
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $i ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url('drawing_history/') . $po[0]->part_number; ?>" class="btn btn-sm btn-primary"> <i class="fas fa-history"></i></a>
                                                                        ...
                                                                        <form action="<?php echo base_url('updatechildpart') ?>" method="POST" enctype='multipart/form-data'>
                                                                            <div class="row">
                                                                                <div class="col-lg-6">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="po_num">Safety/buffer stock </label><span class="text-danger">*</span>
                                                                                        <input type="text" value="<?php echo $po[0]->safty_buffer_stk  ?>" name="usaft_stk" readonly required class="form-control" id="exampleInputEmail1" placeholder="Enter Safety/buffer stock">
                                                                                        <input type="hidden" value="<?php echo $po[0]->hsn_code  ?>" name="hsn_code" readonly required class="form-control" id="exampleInputEmail1" placeholder="Enter Safety/buffer stock">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label> Child Part Type </label><span class="text-danger">*</span>
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="po_num">Revision Number </label><span class="text-danger">*</span>
                                                                                        <input type="text" value="<?php echo $po[0]->revision_no ?>" name="urevision_no" required class="form-control" id="exampleInputEmail1" placeholder="Enter Safty/buffer stock" aria-describedby="emailHelp">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="po_num">Revision Remark </label><span class="text-danger">*</span>
                            ...
                            <td><?php echo $po[0]->safty_buffer_stk ?></td>

                            <td><?php echo $child_part_id[0]->part_type_name ?></td>
                            <td>
                                <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal13<?php echo $i; ?>">
                                    <i class="fas fa-upload"></i>

                                </button> -->
                                <?php

                                                if ($po[0]->part_drawing == "") {
                                                } else {
                                ?>
                                    <a class="btn btn-primary" download href="<?php echo base_url('documents/') . $po[0]->part_drawing ?>">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo base_url('add_part') ?>" method="post" enctype='multipart/form-data'>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <input value="<?php echo $po[0]->id ?>" type="hidden" name="uid" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Customer Name">
                            ...
                            <td>
                                ...
                                ?>
                                    <a class="btn btn-primary" download href="<?php echo base_url('documents/') . $po[0]->cad_file ?>">
                                        <i class="fas fa-download"></i>
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo base_url('add_part') ?>" method="post" enctype='multipart/form-data'>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <input value="<?php echo $po[0]->id ?>" type="hidden" name="uid" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Customer Name">
                                                        <input type="hidden" name="table_name" value="child_part">
                                                        <input type="hidden" name="column_name" value="cad_file">
                            ...
                            <td>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal143<?php echo $i; ?>">
                                    <i class="fas fa-upload"></i>

                                </button>
                                <?php

                                                if ($po[0]->modal_document == "") {
                                                } else {
                                ?>
                                    <a class="btn btn-primary" download href="<?php echo base_url('documents/') . $po[0]->modal_document ?>">
                                        <i class="fas fa-download"></i>
                                ...
                                ?>
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal143<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo base_url('add_part') ?>" method="post" enctype='multipart/form-data'>
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <input value="<?php echo $po[0]->id ?>" type="hidden" name="uid" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Customer Name">
                                                        <input type="hidden" name="table_name" value="child_part">
                                                        <input type="hidden" name="column_name" value="modal_document">
                                ...
                                <div class="modal fade" id="exampleModaledit2333<?php echo $i ?>" tabindex=" -1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog " role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo base_url('updatechildpartNew') ?>" method="POST" enctype='multipart/form-data'>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="po_num">Safety/buffer stock </label><span class="text-danger">*</span>
                                                                <input type="text" value="<?php echo $po[0]->safty_buffer_stk  ?>" name="usaft_stk" required class="form-control" id="exampleInputEmail1" placeholder="Enter Safety/buffer stock">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="po_num">HSN Code</label><span class="text-danger">*</span>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="po_num">Part Description </label><span class="text-danger">*</span>
                                                                <input type="text" value="<?php echo $po[0]->part_description  ?>" name="part_desc" required class="form-control" id="exampleInputEmail1" placeholder="Enter Part Description" aria-describedby="emailHelp">
                                                            </div>
                                                            <div class="form-group">
                                                                <label> Child Part Type </label><span class="text-danger">*</span>
                                                                <select class="form-control select2" name="child_part_id" readonly style="width: 100%;">
