                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                        ...
                                        ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url('view_part_drawing_history/') . $poo->customer_master_id; ?>" class="btn btn-primary btn-sm">history</a>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="hidden" value="<?php echo $customer_part_rate_data[0]->cad ?>" name="cad" required class="form-control" id="exampleInputEmail1" placeholder="Enter Part Rate" aria-describedby="emailHelp">
                                                                                            <input type="hidden" value="<?php echo $customer_part_rate_data[0]->model ?>" name="model" required class="form-control" id="exampleInputEmail1" placeholder="Enter Part Rate" aria-describedby="emailHelp">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-lg-6">
                                                                                        <div class="form-group">
                            ...
                            <td><?php
                                                    if ($customer_part_rate_data[0]->drawing != "") {
                                ?>
                                    <a download href="<?php echo base_url("documents/" . $customer_part_rate_data[0]->drawing) ?>" id="" class="btn btn-sm btn-primary remove_hoverr "> Download</a>
                            ...
                            <td><?php
                                                    if ($customer_part_rate_data[0]->cad != "") {
                                ?>
                                    <a download href="<?php echo base_url("documents/" . $customer_part_rate_data[0]->cad) ?>" id="" class="btn btn-sm btn-primary remove_hoverr ">Download</a>
                                ...
                                ?>
                                    <form action="<?php echo base_url("update_drawing") ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="">Upload Cad File</label>
                                            <input type="file" class="form-control" required name="file">
                                            <input type="hidden" class="form-control" required name="id" value="<?php echo $customer_part_rate_data[0]->id; ?>">
                            ...
                            <td><?php
                                                    if ($customer_part_rate_data[0]->model != "") {
                                ?>
                                    <a download href="<?php echo base_url("documents/" . $customer_part_rate_data[0]->model) ?>" id="" class="btn btn-sm btn-primary remove_hoverr "> Download</a>
                            ...
                            <!-- <td>
                                <a href="<?php echo base_url("bom/" . $customer_data[0]->id) ?>" id="" class="btn btn-sm btn-primary remove_hoverr ">BOM</a>
