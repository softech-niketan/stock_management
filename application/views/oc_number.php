                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">OC Number</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">OC Number</h3>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal">
                                    Add OC Number </button>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="<?php echo base_url('updateOtherData') ?>" method="POST">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="part_name">OC Number</label><span class="text-danger">*</span>
                                                                                <input type="text" value="<?php echo $p->number; ?>" name="uhus_num" required class="form-control" id="hus_num" aria-describedby="emailHelp" placeholder="OC Number">
