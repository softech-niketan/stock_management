                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select onchange="myFunction()" class="form-control select2" id="tax_applicable" name="shipping" style="width: 100%;">
                                                            ...
                                                            <div class="form-group" id="tax_type">
                                                                ...
                                                                <select disabled class="form-control select2" name="tax_type" style="width: 100%;">
