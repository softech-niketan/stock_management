                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-danger" href="<?php echo base_url('inwarding_invoice/') . $new_po_id; ?>">
                                                < Back</a>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            ?>
                                                <button type="button" class="btn btn-primary mt-4" data-toggle="modal" data-target="#exampleModalmatch">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" step="any" name="invoice_amount" placeholder="Enter Invoice Amount" value="" class="form-control">
                                                                            <input type="hidden" name="inwarding_id" value="<?php echo $inwarding_id; ?>" class="form-control">
                                                                            <input type="hidden" name="actual_price" value="<?php echo $actual_price; ?>" class="form-control">
                                                                            <input type="hidden" name="minus_price" value="<?php echo $minus_price; ?>" class="form-control">
                                                                            <input type="hidden" name="plus_price" value="<?php echo $plus_price; ?>" class="form-control">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            ?>
                                                                ...
                                                                <form action="<?php echo base_url('add_grn_qty') ?>" method="post">
                                                                    ...
                                                                    <input type="number" step="any" max="<?php echo $p->pending_qty; ?>" placeholder="Enter Inwarding Qty" name="qty" class="form-control">
                                                                    <input type="hidden" name="inwarding_id" value="<?php echo $inwarding_id ?>" class="form-control">
                                                                    ...
                                                                    <input type="hidden" placeholder="Enter Inwarding Qty" name="pending_qty" value="<?php echo $p->pending_qty ?>" class="form-control">
                                                        ...
                                                        <!-- <td>
                                                                                                            ...
                                                                                                            if ($data_present == "no") {
                                                                                                                ...
                                                                                                                echo "Please Add GRN Qty ";
                                                                                                            } else {
                                                                                                                if ($inwarding_data[0]->status == "generate_grn") {
